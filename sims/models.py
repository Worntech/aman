...
class EYELIDR(models.Model):
    ...
    StatusEYELIDLS = models.TextField()
    StatusCONJUNCTIVARS = models.TextField()
    StatusCONJUNCTIVALS = models.TextField()
    StatusCORNEARS = models.TextField()
    StatusCORNEALS = models.TextField()
    StatusACRS = models.TextField()
    StatusACLS = models.TextField()
    StatusPUPILRS = models.TextField()
    StatusPUPILLS = models.TextField()
    StatusIRISRS = models.TextField()
    StatusIRISLS = models.TextField()
    StatusLENSRS = models.TextField()
    StatusLENSLS = models.TextField()
    StatusVITREOUSRS = models.TextField()
    StatusVITREOUSLS = models.TextField()
    StatusRETINARS = models.TextField()
    StatusRETINALS = models.TextField()
