...
class EYELIDRForm(forms.ModelForm):
    StatusEYELIDR = forms.CharField(
        ...
        widget=forms.Textarea(attrs={
            ...
            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'EYELID R.E',
        }))
    StatusEYELIDLS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'EYELID L.E',
        }))
    StatusCONJUNCTIVARS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'CONJUCTIVA R.E',
        }))
    StatusCONJUNCTIVALS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'CONJUCTIVA L.E',
        }))
    
    StatusCORNEARS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'CORNEA R.E',
        }))
    StatusCORNEALS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'CORNEA L.E',
        }))
    StatusRETINARS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'RETINA R.E',
        }))
    StatusRETINARS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={
            ...
            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'RETINA L.E',
        }))
    StatusACRS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={
    ...
    StatusPUPILRS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'PUPIL R.E',
        }))
    StatusPUPILLS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'PUPIL L.E',
        }))
    StatusIRISRS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'IRIS R.E',
        }))
    StatusIRISLS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'IRIS L.E',
        }))
    StatusLENSRS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'LENS R.E',
        }))
    StatusLENSLS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'LENS L.E',
        }))
    StatusVITREOUSRS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'VITREOUS R.E',
        }))
    StatusVITREOUSLS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={

            'rows': '3',
            'id': 'EYELIDR',
            'placeholder' : 'VITREOUS L.E',
        }))
    StatusRETINARS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={
    ...
    StatusRETINALS = forms.CharField(
        label=False,
        widget=forms.Textarea(attrs={
    ...
    class Meta:
        model = EYELIDR
        fields = ('StatusEYELIDR', 'StatusEYELIDLS', 'StatusCONJUNCTIVARS', 'StatusCONJUNCTIVALS', 'StatusCORNEARS', 'StatusCORNEALS', 'StatusACRS', 'StatusACLS', 'StatusPUPILRS', 'StatusPUPILLS', 'StatusIRISRS', 'StatusIRISLS', 'StatusLENSRS', 'StatusLENSLS', 'StatusVITREOUSRS', 'StatusVITREOUSLS', 'StatusRETINARS', 'StatusRETINALS',)
